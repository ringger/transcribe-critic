...
class TestApiCallWithRetry:
    ...
    @patch("transcribe_critic.shared.time.sleep")
...
class TestCheckDependencies:
    @patch("transcribe_critic.shared.shutil.which", return_value="/usr/bin/tool")
    def test_cli_tools_found(self, mock_which):
        deps = check_dependencies()
        assert deps["yt-dlp"] is True
        assert deps["ffmpeg"] is True

    @patch("transcribe_critic.shared.shutil.which", return_value=None)
